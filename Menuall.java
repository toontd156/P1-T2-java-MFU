...
public class Menuall extends Menu_inheritance{
	...
	comebackbook cm = new comebackbook();
	comebackbook Math=new comebackbook();
	comebackbook Car=new comebackbook();
	comebackbook Anima=new comebackbook();
	...
	public void ConfriminCart(){
		...
		if(cf == 'Y' )
		{
			...
			System.out.println("ไม่คือต้องเสียเงินนะจ๊ะ");
	...
	public void givebook(){
		...
		if(a >= 1){
            ...
            if( c >= day){
                ...
                System.out.println("ต้องการจ่ายมั้ย Y/D ");
                char p = scanner.next().charAt(0);
                if(p == 'Y'){
                    
                    System.out.println("จ่ายเท่าไหร่");
